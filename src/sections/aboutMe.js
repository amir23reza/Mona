          ...
          <MDBCol lg="8" md="8" sm="12">
            {activeSegment == 1 ? (
              <MDBAnimation reveal type="fadeInDown" duration="1000ms" className="descriptionContainer">
                ...
                Awarded from the head of Architecture Department as being
                 a member of Architecture Students Union Committee
              ...
              <MDBAnimation reveal type="fadeInUp" duration="1000ms" className="descriptionContainer">
                <div className="marginTop" />
                <p className="descriptionP">
                Was coach of student organizations for their summer 
                camps in Ramsar, Iran.(From secondary schools in district five, Tehran.)<br/>
              ...
              <MDBAnimation reveal type="fadeInDown" duration="1000ms" className="descriptionContainer">
                <div className="marginTop" />
                <p className="descriptionP">
                Working in Rayan Pajouh Salamat company as a Ui/Ux designer and software tester.
                I have learned how to communicate with client and be patient in my way.
                </p>
