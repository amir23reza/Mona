    ...
    return ( <
        ...
        sm = "12" > { " " } {
            activeSegment == 1 ? ( <
                ...
                <
                p className = "descriptionP" >
                Working in Rayan Pajouh Salamat company as a Ui / Ux designer and software tester.I have learned how to communicate with client and be patient in my way. { " " } <
                /p>{" "} <
