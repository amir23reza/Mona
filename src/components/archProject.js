...
import {
    MDBRow, MDBCol, MDBAnimation
} from 'mdbreact'
import { Link } from 'react-router-dom'

const ArchProject = ({ title, location, date, img, linkTo, delay }) => {
    return (
        <MDBAnimation className="archProject" type="fadeInDown" duration="1200ms" delay={delay}>
            <Link to={linkTo}>
                <div className="archProjectContainer" style={{ backgroundImage: `url(${img})` }}>
